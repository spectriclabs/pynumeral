...
def test_all():
    ...
    assert pynumeral.format(1, "0,0.[000000]") == "1"
    assert pynumeral.format(1.000000001, "0,0.[000000]") == "1"
    assert pynumeral.format(1.1, "0,0.[000]") == "1.1"
    assert pynumeral.format(1.12, "0,0.[000]") == "1.12"
    assert pynumeral.format(1.123, "0,0.[000]") == "1.123"
    assert pynumeral.format(1.1234, "0,0.[000]") == "1.123"
    assert pynumeral.format(1.1, "0,0.000") == "1.100"
    assert pynumeral.format(1.12, "0,0.000") == "1.120"
    assert pynumeral.format(1.123, "0,0.000") == "1.123"
    assert pynumeral.format(1.1234, "0,0.000") == "1.123"
